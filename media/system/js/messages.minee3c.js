class AlertElement extends HTMLElement {
  ...
  attributeChangedCallback(t, o, e) {
    switch (t) {
      case "type":
        (!e ||
          (e && ["info", "warning", "danger", "success"].indexOf(e) === -1)) &&
          (this.type = "info");
        break;
      case "role":
        (!e || (e && ["alert", "alertdialog"].indexOf(e) === -1)) &&
          (this.role = "alert");
        break;
      case "dismiss":
        (!e || e === "") && (!o || o === "")
          ...
          : this.button && e === "false"
          ? this.destroyCloseButton()
          : !this.button && e !== "false" && this.createCloseButton();
        break;
      case "close-text":
        (!e || e !== o) &&
          this.button &&
 ...
 */ const getMessageContainer = (s) => {
  ...
  return s instanceof HTMLElement
    ? s
    : (typeof s > "u" || (s && s === "#system-message-container")
        ? (t = document.getElementById("system-message-container"))
...
(Joomla.renderMessages = (s, t, o, e) => {
  ...
  (typeof o > "u" || (o && o === !1)) && Joomla.removeMessages(h),
    Object.keys(s).forEach((i) => {
      ...
      if (
        (["success", "info", "danger", "warning"].indexOf(i) < 0 &&
          ((n = i === "notice" ? "info" : i),
        ...
        (r.className = "alert-heading"),
          (r.innerHTML = Joomla.sanitizeHtml(
            `<span class="${i}"></span><span class="visually-hidden">${
              Joomla.Text._(i) ? Joomla.Text._(i) : i
            }</span>`
          )),
          a.appendChild(r);
      }
      ...
      (l.className = "alert-wrapper"),
        u.forEach((r) => {
          l.innerHTML += Joomla.sanitizeHtml(
            `<div class="alert-message">${r}</div>`
          );
        }),
        a.appendChild(l),
        h.appendChild(a);
  ...
  (Joomla.removeMessages = (s) => {
    getMessageContainer(s)
      .querySelectorAll("joomla-alert")
      .forEach((o) => o.close());
  }),
  document.addEventListener("DOMContentLoaded", () => {
    ...
    s &&
      Object.keys(s).map((t) =>
        Joomla.renderMessages(s[t], void 0, !0, void 0)
      );
  });
